...
usage:
	...
	@echo "\033[0;35mdestroy\033[0m\t\t\tTears down all infrastructure components (runs all destroy.* targets)"
	@echo "\033[0;35mdestroy.pubsub\033[0m\t\tDeletes all Pub/Sub subscriptions"
	@echo "\033[0;35mdestroy.topics\033[0m\t\tDeletes all Pub/Sub topics"
	@echo "\033[0;35mdestroy.services\033[0m\tDeletes all Cloud Run services"
	@echo "\033[0;35mdestroy.functions\033[0m\tDeletes all Cloud Functions"
	@echo "\033[0;35mdestroy.iam\033[0m\t\tDeletes all IAM service accounts"
	@echo "\033[0;35mdestroy.bucket\033[0m\t\tDeletes the Cloud Storage bucket"
	@echo "\033[0;35mdestroy.scheduler\033[0m\tDeletes the Cloud Scheduler job"
